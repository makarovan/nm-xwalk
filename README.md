...
## Environments
- Preview: https://main--nm-xwalk--makarovan.hlx.page/
- Live: https://main--nm-xwalk--makarovan.hlx.live/
...
1. Open the `nm-xwalk` directory in your favorite IDE and start coding :)
